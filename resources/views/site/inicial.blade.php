...
@section('banner')
  ...
  <section id="intro">
    <div class="intro-content">
      ...
      <div>
        <a href="https://api.whatsapp.com/send?phone=5596984058000" class="btn-get-started scrollto">Fale com um especialista</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 about-img">
          <img src="img/sobre/home.svg" alt="home.svg">
        </div>

        <div class="col-lg-6 content">
          <h3>Agencia de Marketing Digital, especializada em criação de sites, inbound marketing, SEO, mídia online e
            gestão de redes sociais.</h3>
          <h2>Atraia mais clientes pela web, com a AlexRodri Digital</h2>
          <p><i class="ion-android-checkmark-circle"></i> A AlexRodri Digital é uma agência que acredita que os meios de
            comunicação tradicional tem um alto valor para investimento que poder ser melhor direcionado. Num mundo
            conectado, onde os consumidores são agentes ativos, o modelo de interrupção e de monólogo da mídia de massa já
            não é tão eficiente.</p>
        </div>
      </div>
        ...
        @foreach ($post as $p)
          <div class="col-lg-6 grid-item">
            <div class="box wow fadeInLeft">
              ...
              <h2 class="title"><a href="{{ Route('post', [$p->id, Str::slug($p->titulo)]) }}">{{ $p->titulo }}</a>
              </h2>
