...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	<head>
		...
		<meta name="twitter:description" content="Site da agência amapaense AlexRodri Digital, que faz serviços na area de internet e tecnologias! Sites, Aplicativos, Marketing, Fotos, Videos e muito mais.">
		...
		})(window,document,'script','dataLayer','GTM-M42MGNZ');</script>
	...
	<body id="body">
				...
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						...
						<li class="@yield('menu-servicos-class') menu-has-children">
							...
							<ul>
								@foreach ($fs as $s)
								<li><a href="{{ route('servicoshow',[$s->id, Str::slug($s->titulo)]) }}">{{ $s->titulo }}</a></li>
								@endforeach
							</ul>
						</li>
						...
						<li class="">
							<a class="btn btn-45off text-white" href="https://api.whatsapp.com/send?phone=5596984058000">Pedir Orçamento</a>
						</li>
						@auth
						<li class="@yield('menu-contato-class')">
				...
				<nav class="py-3 row">
					<div class="col-md-8 row">
						...
						<div class="col-md-6">
							...
							@foreach ($fs as $s)
								<div>
									<i class="ion-arrow-right-b"></i><a href="{{ route('servicoshow',[$s->id, Str::slug($s->titulo)]) }}">{{ $s->titulo }}</a>
								</div>
							@endforeach
						</div>
						<div class="col-md-6">
		...
		<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M42MGNZ"
