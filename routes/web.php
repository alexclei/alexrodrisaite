...
if (Request::server('HTTP_HOST') != 'localhost:8000' || Request::server('HTTP_HOST') != 'localhost')
{
...
Route::namespace('Site')->group( function(){
	...
	Route::get('/servicos/orcamento','SiteController@orcamento')->name('servico_orcamento')->middleware('auth');
	Route::post('/servicos/orcamento','SiteController@enviarOrcamento')->name('enviarorcamento');
	Route::get('/obrigado/{name}','SiteController@obrigado')->name('lead');
